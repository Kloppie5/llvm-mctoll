...
def generate_recognizer(tree, isa, debug = True):
  ...
  with \
    open(f'{isa}_recognizer.h', 'w') as fh, \
    open(f'{isa}_recognizer.cpp', 'w') as fcpp:
    fh.write(f"""
// This file was generated by {__file__} on {timestamp}
#ifndef {isa.upper()}_RECOGNIZER_H
#define {isa.upper()}_RECOGNIZER_H
...
#endif // {isa.upper()}_RECOGNIZER_H
""")

    fcpp.write(f"""
// This file was generated by {__file__} on {timestamp}
#include "{isa}_recognizer.h"

namespace {{

  {isa}_ID recognize_{isa}(uint32_t data) {{
{''.join(recognizer)}
    return {isa}_ID::UNKNOWN;
  }}
