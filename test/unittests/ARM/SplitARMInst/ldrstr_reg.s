...
# CHECK: %0:gprnopc = ADDrr $r0, $r1
# CHECK-NEXT: STRi12 $r0, %0:gprnopc, 0
# CHECK-NEXT: %1:gprnopc = ADDrr $r0, $r1
# CHECK-NEXT: $r0 = LDRi12 %1:gprnopc, 0
# CHECK: ARMInstrSplitter end

# CHECK: ARMInstrSplitter start
# CHECK: %0:gprnopc = ADDrr $r0, $r1, 0, $cpsr
# CHECK-NEXT: STRi12 $r0, %0:gprnopc, 0, 0, $cpsr
# CHECK-NEXT: %1:gprnopc = ADDrr $r0, $r1, 0, $cpsr
# CHECK-NEXT: $r0 = LDRi12 %1:gprnopc, 0, 0, $cpsr
# CHECK: ARMInstrSplitter end
